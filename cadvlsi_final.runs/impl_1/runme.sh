...
HD_PWD='C:/Users/EE720a/cadvlsi_final/cadvlsi_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TDE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TDE.tcl -notrace
