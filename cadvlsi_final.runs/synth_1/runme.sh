...
HD_PWD='C:/Users/EE720a/cadvlsi_final/cadvlsi_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TDE.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TDE.tcl
